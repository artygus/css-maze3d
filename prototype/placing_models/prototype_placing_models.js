...
(function() {
  ...
  window.PrototypeGameLogicRendered = (function() {
    ...
    function PrototypeGameLogicRendered() {
      ...
      this.renderGod = new Renderer(worldEl, unit);
      this.renderGod.cells(this.getTestLevel());
      this.camera = new GameCamera(viewportEl, worldEl, cameraEl, unit);
      this.camera.camera.moveDelta(0, 0, -35);
      ...
      setTimeout(((function(_this) {
        return function() {
          _this.updatePlayerPosition();
          return _this.placeModel();
        };
      })(this)), 2000);
      this.initkeyboard();
    }
    ...
    PrototypeGameLogicRendered.prototype.placeModel = function() {
      var model;
      model = new DummyModel();
      return this.renderGod.modelPlace(model, [222, 209], dataTypes.WorldDirection.N);
    };
