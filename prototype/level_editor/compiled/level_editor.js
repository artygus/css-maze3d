...
(function() {
  var centerGrid, desectAll, getCenterGridX, getCenterGridY, getIndex, getXYfromCell, makeCell, positionGrid, renderGrid;
  ...
  $(function() {
    ...
    return grid.find('[cell]').on('click', function(e) {
